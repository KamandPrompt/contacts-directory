...
<source src="http://thenewcode.com/assets/videos/polina.mp4" type="video/mp4">
            ...
            <h3>Contacts Directory - PHD</h3>
            <input type="text" name="search" id="searchphd" placeholder="Search by Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Search by Name'">
            <table>
                <tr>
                    <th>Roll No.</th>
                    <th>Name</th>
