...
<html>
    ...
    <body>
        ...
        <div id="myPage" class="page">
            ...
            <h3>Contacts Directory - M.Tech</h3>
            <input type="text" name="search" id="searchmtech" placeholder="Search by Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Search by Name'">
            <table>
                <tr>
                    <th>Roll No.</th>
                    <th>Name</th>
