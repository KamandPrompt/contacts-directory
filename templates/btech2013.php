...
<html>
    <head>
        <title> Contacts - BTech 2013</title>
       <link rel = "stylesheet"
   type = "text/css"
   href = "../public/css/myStyle.css" />
    ...
    <body>
        ...
        <div id="myPage" class="page">
            ...
            <h3>Contacts Directory - BTech 2013</h3>
            <input type="text" name="search" id="searchb2013" placeholder="Search by Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Search by Name'">
            <table>
                <tr>
                    <th>Roll No.</th>
                    <th>Name</th>
