...
<html>
    <head>
        <title> Contacts - BTech 2015</title>
        <style>
    ...
    <body>
        ...
        <div id="myPage" class="page">
            ...
            <h3>Contacts Directory - BTech 2015</h3>
            <input type="text" name="search" id="searchb2015" placeholder="Search by Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Search by Name'">
            <table>
                <tr>
                    <th>Roll No.</th>
                    <th>Name</th>
