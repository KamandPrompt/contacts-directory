...
<html>
    ...
    <body>
        ...
        <div id="myPage" class="page">
            ...
            <h3>Contacts Directory - M.Sc.</h3>
            <input type="text" name="search" id="searchmsc" placeholder="Search by Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Search by Name'">
            <table>
                <tr>
                    <th>Roll No.</th>
                    <th>Name</th>
